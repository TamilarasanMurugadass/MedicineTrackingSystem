        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicines_AspNetUsers_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportName = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReportType = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    FileFormat = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GeneratedBy = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicineBatches_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    AlertType = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MedicineId = table.Column<int>(type: "int", nullable: false),
                    ...
                    ReadBy = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Alerts_AspNetUsers_ReadBy",
                        column: x => x.ReadBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Alerts_MedicineBatches_MedicineBatchId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionType = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 23, 11, 31, 28, 145, DateTimeKind.Utc).AddTicks(5493), "Administrator with full system access", "Admin", new DateTime(2025, 9, 23, 11, 31, 28, 145, DateTimeKind.Utc).AddTicks(6048) },
                    { 2, new DateTime(2025, 9, 23, 11, 31, 28, 145, DateTimeKind.Utc).AddTicks(6411), "Pharmacist with inventory management permissions", "Pharmacist", new DateTime(2025, 9, 23, 11, 31, 28, 145, DateTimeKind.Utc).AddTicks(6412) },
                    { 3, new DateTime(2025, 9, 23, 11, 31, 28, 145, DateTimeKind.Utc).AddTicks(6416), "Staff member with limited access", "Staff", new DateTime(2025, 9, 23, 11, 31, 28, 145, DateTimeKind.Utc).AddTicks(6416) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alerts_MedicineBatchId",
                table: "Alerts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineBatches_CurrentQuantity",
                table: "MedicineBatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineBatches_IsActive",
                table: "MedicineBatches",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicines_Manufacturer",
                table: "Medicines",
                column: "Manufacturer");
