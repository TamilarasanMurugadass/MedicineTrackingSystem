    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{totalMedicines}</dd>
              </dl>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{lowStockBatches}</dd>
              </dl>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{expiredBatches}</dd>
              </dl>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{activeBatches}</dd>
              </dl>
            </div>
          </div>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-500">Usage This Week</div>
            </div>
            <div className="flex items-center">
              <ArrowTrendingUpIcon className={`h-5 w-5 ${usageTrend >= 0 ? 'text-green-500' : 'text-red-500'}`} />
              <span className={`text-sm font-medium ml-1 ${usageTrend >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-gray-900">{expiringBatches}</div>
